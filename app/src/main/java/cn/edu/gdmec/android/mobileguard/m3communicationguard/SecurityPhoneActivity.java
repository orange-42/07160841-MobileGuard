...
public class SecurityPhoneActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private List<BlackContactInfo> pageBlakNumber = new ArrayList<BlackContactInfo>();
    ...
    private void fillData(){
        ...
        if(totalNumber == 0) {
            ...
            if(adapter == null){
                adapter = new BlackContactAdapter(pageBlakNumber,
                        SecurityPhoneActivity.this);
                adapter.setCallBack(new BlackContactAdapter.BlackConatctCallBack(){
