...
public class BlackContactAdapter extends BaseAdapter{
    ...
    private BlackConatctCallBack callBack;
    ...
    public interface BlackConatctCallBack {
        void DataSizeChanged();
    }
    public void setCallBack(BlackConatctCallBack callBack){
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if(view==null){
            ...
            holder.mTypeTV = (TextView) view
                    .findViewById(R.id.tv_black_modeStyle);
